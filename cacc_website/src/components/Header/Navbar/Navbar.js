            ...
            <div className="container-fluid">
                ...
                <ul className={!androidPage ? "navbar-nav me-auto mb-2 mb-lg-0" : "navbar-nav me-auto mb-2 mb-lg-0 navbar-android"}>
                    <li className="nav-item">
                        <a className="nav-link active" aria-current="page" href="#"><Link className="UBoxLink" to="/inicio">Início</Link></a>
                    </li>
                    <li className="nav-item">
                    <a className="nav-link" href="#"><Link className="UBoxLink" to="/eventos">Eventos</Link></a>
                    </li>
                    <li className="nav-item">
